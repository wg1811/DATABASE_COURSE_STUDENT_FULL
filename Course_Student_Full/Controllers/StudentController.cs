...
public class StudentController : ControllerBase
{
    ...
    public async Task<ActionResult<StudentDTO>> GetStudentWidtCourse(int id)
    {
        ...
        .Include(s => s.Courses) //we added course
    ...
    {
        var existedStudent = await _context.Students.FirstOrDefaultAsync(s => s.Email == student.Email);
    ...
    {
        var student = await _context.Students
        .Include(s => s.Courses) //include course 
    ...
    public async Task<ActionResult<Student>> UpdateStudent(int id, [FromBody] Student updatedStudent) // ✅ Include `id` from URL
    {
